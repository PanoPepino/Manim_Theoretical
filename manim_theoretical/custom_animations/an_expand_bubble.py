...
class Expand(AnimationGroup):
   ...
   Parameters:
        ...
        - rot: if None, nothing happens. if YES, takes the inside text and rotate around BH (10D spinning black hole feature)
    """
    def __init__(self, vgroup, scale, rot = None, **kwargs):
        self.vgroup = vgroup
        self.scale = scale
        if rot is None:
            super().__init__(
