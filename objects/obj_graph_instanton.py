...
class Graph_Instanton(Group):
    """This is a class to represent an instanton potential with a false and true minima. The position of the field is the last argument. The valuetracker is a property of the class. Call with xx.tracker_ins, where xx is the name of the object.
    ...
    def __init__(self,**kwargs):
        ...
        field_position.add_updater(lambda y: y.move_to(ax_ins.c2p(self.tracker_ins.get_value(),0)))
        
        self.add(ax_ins, lab_ax_ins, pot_ins, minima_labels, field_position)